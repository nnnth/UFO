...
from mmdet.utils import ConfigType, SampleList, get_classes, get_palette
from mmdet.visualization import SegLocalVisualizer
...
class MMSegInferencer(BaseInferencer):
    ...
    def _init_pipeline(self, cfg: ConfigType) -> Compose:
        ...
        load_semseg_idx = self._get_transform_idx(pipeline_cfg,
                                               'SegLoadAnnotations')
        if load_semseg_idx != -1:
            del pipeline_cfg[load_semseg_idx]
