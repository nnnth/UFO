...
model = dict(
    ...
    pretrain_path='./ufo-internvl2_5-8b-multi-448.pth',
    train_mlp=True,
    train_vit=True,
...
train_dataloader = dict(
    ...
    sampler=dict(type='GroupMultiSourceNonMixedSampler', batch_size=1, source_ratio=[
                 ...
                 if_group=[True,True,False], shuffle=True),
    batch_sampler=None,
...
max_iters=60000
train_cfg = dict(
    type='IterBasedTrainLoop', max_iters=max_iters, val_interval=60000)
