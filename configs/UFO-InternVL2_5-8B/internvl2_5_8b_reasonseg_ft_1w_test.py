...
model = dict(
    ...
    lora_r=8,
    lora_alpha=2*8,
    pretrain_path='./ufo-internvl2_5-8b-reasonseg.pth',
    tokenizer=dict(type='AutoTokenizer', 
        name_or_path='./ckpt/InternVL2_5-8B',
...
train_dataloader = dict(
    ...
    sampler=dict(type='GroupMultiSourceNonMixedSampler', batch_size=4, source_ratio=[
                                                                                    ...
                                                                                    vqa_ratio,
                                                                                    reasonseg_ratio], 
                if_group=[False,False,False,False,False,False,False], shuffle=True),
    batch_sampler=None,
    dataset=dict(type='ConcatDataset',
        ...
        datasets=[
            ...
            # VQA
            dict(type='LLaVAOneVision',
                data_root='data/llava_onevision',
                img_dir='data/llava_onevision/images/',
...
optim_wrapper = dict(
    ...
    optimizer=dict(type='AdamW', lr=0.0000002, weight_decay=0.01),
    )
